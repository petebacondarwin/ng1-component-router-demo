    ...
    function outletLink(scope, element, attrs, ctrls, $transclude) {
        var Outlet = (function () {
            ...
            Outlet.prototype.activate = function (instruction) {
                ...
                if (this.currentComponent && this.currentComponent.$routerOnActivate) {
                    return this.currentComponent.$routerOnActivate(this.router, instruction, previousInstruction);
                }
                return $q.when();
            };
            return Outlet;
